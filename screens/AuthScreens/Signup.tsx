  ...
  render() {
    return (
      <View style={{ flex: 1, alignItems: 'center', }}>
        <Image source={require('../../assets/backgrounds/background-white.jpg')} style={styles.backgroundImage} />
        ...
        {/* <TextInput 
              ...
              /> */}
        <SelectDropdown style={styles.textinput} 
          data={this.roles}
...
const styles = StyleSheet.create({
  ...
  textinput: {
    ...
    color: 'black', paddingHorizontal: 20,
